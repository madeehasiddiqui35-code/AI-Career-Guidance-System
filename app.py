...
if page == "Dashboard":
    ...
    if st.button("Analyze Resume"):
        ...
        if "project" in resume_text.lower():
            feedback.append("Good: You included projects")
        else:
            feedback.append("Add more projects section")

        if "github" in resume_text.lower():
            feedback.append("Good: GitHub link found")
        else:
            feedback.append("Add GitHub link")

        if "python" in resume_text.lower():
            feedback.append("Good: Python skill mentioned")

        else:
            feedback.append("Add python skill")

        if len(resume_text)<200:
            feedback.append("Resume too short, needs more detail")
    ...
    if st.button("Get Answer"):
        ...
        if "data science" in question.lower():
            st.write("""
    ...
    """)
        ...
        elif "ai engineer" in question.lower():
            st.write("""
    ...
    """)
        ...
        elif "software engineer" in question.lower():
           st.write("""
    ...
    """) 
        ...
        elif "web developer" in question.lower():
            st.write("""
        ...
        """)
            ...
            st.write(
            "Sorry, I don't know that yet. Try asking about Data Science, AI Engineer, Software Engineer, or Web Developer."
        )